...
import eyeOpen from '../images/eye-opened.png';
...
export const PreloadImages: FunctionComponent = () => {
    return <PreloadImagesWrapper>
        ...
        <img src={crossHover} alt="CrossHover"/>
        <img src={smoothOff} alt="SmoothOff"/>
        <img src={smoothOffHover} alt="SmoothOffHover"/>
        <img src={zoomIn} alt="ZoomIn"/>
        <img src={zoomInHover} alt="ZoomInHover"/>
        <img src={coordinateOff} alt="CoordinateOff"/>
        <img src={coordinateOffHover} alt="CoordinateOffHover"/>
        ...
        <img src={x15} alt="X15"/>
        <img src={x15Hover} alt="X15Hover"/>
        <img src={x16} alt="X16"/>
        <img src={x16Hover} alt="X16Hover"/>
        <img src={x7} alt="X7"/>
        <img src={x7Hover} alt="X7Hover"/>
        <img src={x8} alt="X8"/>
        <img src={x8Hover} alt="X8Hover"/>
        ...
        <img src={x14Hover} alt="X14Hover"/>
        <img src={x17} alt="X17"/>
        <img src={x17Hover} alt="X17Hover"/>
        <img src={x18} alt="X18"/>
        <img src={x18Hover} alt="X18Hover"/>
        <img src={x19} alt="X19"/>
        <img src={x19Hover} alt="X19Hover"/>
        <img src={x20} alt="X20"/>
        <img src={x20Hover} alt="X20Hover"/>
        <img src={x21} alt="X21"/>
        <img src={x21Hover} alt="X21Hover"/>
        <img src={x22} alt="X22"/>
        <img src={x22Hover} alt="X22Hover"/>
        <img src={x23} alt="X23"/>
        <img src={x23Hover} alt="X23Hover"/>
        <img src={x24} alt="X24"/>
        <img src={x24Hover} alt="X24Hover"/>
