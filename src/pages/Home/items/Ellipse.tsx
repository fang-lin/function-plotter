...
export const Ellipse: FunctionComponent = () => {
    ...
    return (
        <EquationsListItem>
            ...
            <Paragraph>
                <Link to={equationsURL([a1b1], 10)}>a=1, b=1</Link>{' '}
                <Link to={equationsURL([a2b1], 10)}>a=2, b=1</Link>{' '}
                <Link to={equationsURL([a1b2], 10)}>a=1, b=2</Link>{' '}
                <Link to={equationsURL([a3b2], 10)}>a=3, b=2</Link>{' '}
                <Link to={equationsURL([a2b3], 10)}>a=2, b=3</Link>;
            </Paragraph>
            <FooterParagraph>
                <Anchor
