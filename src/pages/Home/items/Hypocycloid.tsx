...
const expression = (k: number, upper: number): string =>
    `x=1(${k}-1)cos(t)+1*cos((${k}-1)t);y=1(${k}-1)sin(t)-1*sin((${k}-1)t);[0,${upper}PI]`;
...
export const Hypocycloid: FunctionComponent = () => {
    ...
    return (
        <EquationsListItem>
            ...
            <FooterParagraph>
                <Anchor
                    href="https://en.wikipedia.org/wiki/Hypocycloid"
                    target="_blank"
