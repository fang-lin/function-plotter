...
export const Hyperbola: FunctionComponent = () => {
    ...
    return (
        <EquationsListItem>
            <Head3>
                <Link to={url}>Hyperbola</Link>
            </Head3>
            <Paragraph>
                <Link to={url}>y=a/x;</Link>
            </Paragraph>
            <Paragraph>
                <Link to={equationsURL([a1], 10)}>a=1;</Link>{' '}
                <Link to={equationsURL([am1], 10)}>a=-1;</Link>{' '}
                <Link to={equationsURL([a2], 10)}>a=2;</Link>{' '}
                <Link to={equationsURL([am2], 10)}>a=-2;</Link>{' '}
                <Link to={equationsURL([a3], 10)}>a=3;</Link>{' '}
                <Link to={equationsURL([am3], 10)}>a=-3;</Link>
            </Paragraph>
            <FooterParagraph>
                <Anchor
                    href="https://en.wikipedia.org/wiki/Hyperbola"
                    target="_blank"
